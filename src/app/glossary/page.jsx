...
const Glossary = () => {
  ...
  return (
    <div className="text-black pb-5">
      ...
      <h1 className="p-4 text-center text-2xl mx-[100px]">
        Welcome to the Ultimate Calisthenics Glossary. You will find all the
        calisthenics moves, skills and exercises here. You will also find all
        the variations of a move. We also have links to learning resources for
        all the moves.
      </h1>
      <div className="mx-[30px] my-2.5 border-[0.1px] border-solid"></div>
        ...
        {alphabetKeys.map((letter) => (
          <div key={letter} className="mb-5">
            ...
            {groupedKeywords[letter].map((keyword) => (
              <div className="border-[1px] shadow border-solid p-4 rounded-lg mx-auto">
                <h2 className="text-center text-xl font-bold mb-4">
                  {keyword.title}
                </h2>
                <div className="grid grid-cols-3">
                  <div className="col-span-1 h-[300px] relative border-[1px] border-solid">
                    <Image
                      src={keyword.image}
                      alt=""
                      placeholder="blur"
