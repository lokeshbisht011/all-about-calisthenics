export const gyms = [
    // ---------- Bangalore ----------
    {
      slug: "republic-of-domination",
      name: "Republic of Domination",
      city: "Bangalore",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipM6hp-XgcYaPv6WwLbgoKbPLbb97j1fiTFnJxra",
      locations: [
        { label: "Panduranga Nagar", map: "https://maps.app.goo.gl/xrakRk2YAnrX9HSd7" },
      ],
      description:
    ...
    },
    {
      ...
      city: "Bangalore",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipOE1oSZ0OkLAoE7j7tO1WTK5geJi3nN55jr-biM",
      locations: [
        { label: "Koramangala", map: "https://maps.app.goo.gl/mWh2dhuqwqeWb4yM9" },
      ],
      description:
    ...
    },
    {
      ...
      city: "Bangalore",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipNAGnxPJVsWM7iOqQeFuDBKwXVRLIuwYig3QZzK",
      locations: [
        { label: "Chikkalasandra", map: "https://maps.app.goo.gl/GiQzrUFAq5AuCoU17" },
      ],
      description:
    ...
    },
    {
      ...
      locations: [
        { label: "Kalyan Nagar", map: "https://maps.app.goo.gl/TroDC7T1CCzJJ5Cp8" },
      ],
      description:
    ...
    // ---------- Mumbai ----------
    {
      ...
      city: "Mumbai",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipMmU5heJsMF0_JPsO3h2iwstnu91FD_-Xrh3J7x=w408-h275-k-no",
      locations: [
        { label: "Malad West, Bandra West", map: "https://maps.app.goo.gl/GGQs7dXoxpJqXhGRA" },
    ...
    },
    {
      ...
      locations: [{ label: "Goregaon", map: "https://maps.app.goo.gl/e42hqfeKAf9aiHeo7" }],
      description:
    ...
    },
    {
      ...
      city: "Mumbai",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipP9mUv8IwaH120LX9lI8Dc7VAPLhyp5e7NX9BuP=w408-h725-k-no",
      locations: [{ label: "Borivali West", map: "https://maps.app.goo.gl/b6o26Bm5vkrEfuMF8" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Malad West", map: "https://maps.app.goo.gl/g89i9Fgrpw2eivoe8" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Vikhroli", map: "https://maps.app.goo.gl/297tEUZLYC8Cq7Cg6" }],
      description:
    ...
    // ---------- Pune ----------
    {
      ...
      locations: [{ label: "Wakad", map: "https://maps.app.goo.gl/d3zL2XFs6hLmTzMM6" }],
      description:
    ...
    },
    {
      ...
      city: "Pune",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipMa_AKS6H0ANQHOeoBO82a0veZwZe1fPcC3DWBe=w408-h544-k-no",
      locations: [{ label: "Kalyani Nagar", map: "https://maps.app.goo.gl/6Y9uGDjhwPieWANo9" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Ghorpadi", map: "https://maps.app.goo.gl/CeZeLMbzK7jVWKKx8" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Balewadi", map: "https://maps.app.goo.gl/BHFPjn9ZiaRurhhk9" }],
      description:
    ...
    },
    {
      ...
      city: "Pune",
      image:
        "https://lh5.googleusercontent.com/p/AF1QipPV-3-EnGbIZUFSNhOb85ynlwLo5eZv5xiKOiIi=w408-h544-k-no",
      locations: [
        { label: "Shaniwar Peth", map: "https://maps.app.goo.gl/etnTAgmW8hBwZp9s6" },
        { label: "Sinhagad Road", map: "https://maps.app.goo.gl/etnTAgmW8hBwZp9s6" },
      ],
      description:
    ...
    // ---------- Delhi ----------
    {
      ...
      locations: [
        { label: "Bhalswa Jahangir Village", map: "https://maps.app.goo.gl/GxYq7VuHtV8oDUP9A" },
      ],
      description:
    ...
    },
    {
      ...
      city: "Delhi",
      image: "/images/placeholder.jpg",
      locations: [{ label: "Vikaspuri", map: "https://maps.app.goo.gl/3578q9ejzFLjrnau5" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Dwarka", map: "https://maps.app.goo.gl/xbDgr9t8krp3RyFR6" }],
      description:
    ...
    },
    {
      ...
      locations: [{ label: "Shahdara", map: "https://maps.app.goo.gl/4TTYjkgABGYVK3ZZ6" }],
      description:
